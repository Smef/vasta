...
![Example of autocomplete showing the valid column names](/img/docs/content/1.getting-started/column-autocomplete.png)

![Example type safety not allowing invalid columns, and a type error when an invalid column is entered](/img/docs/content/1.getting-started/invalid-column.png)

![Example type safety not allowing values, and a type error when an invalid value is entered](/img/docs/content/1.getting-started/invalid-value.png)
