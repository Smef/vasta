...
const allCapsPersonName = person.name; // runs the get function and returns "JOE" even the actual attribute value is "Joe"
...
```ts
const upperName = pet.upperName; // upperName autocompetes and appears as read-only attribute on the model
```
